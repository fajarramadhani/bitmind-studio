      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[minmax(0,5fr)_minmax(0,6fr)] lg:items-center lg:gap-16">
          <FadeIn>
            <div className="flex flex-col gap-6">
              ...
              {(project.challenge || project.approach) && (
                <div className="grid gap-6 border-y border-background/10 py-6 md:grid-cols-2">
                  {project.challenge && (
                    <div>
                      <h4 className="text-xs font-semibold uppercase tracking-wider text-background/50 mb-2">
                        The Challenge
                      </h4>
                      <p className="text-sm leading-relaxed text-background/80 line-clamp-4">
                        {project.challenge}
                      </p>
                    </div>
                  )}
              ...
              <div>
                <Link
                  ...
                  className="group inline-flex items-center gap-2 rounded-full bg-background px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-background/90"
                >
                  View Case Study
          ...
          <FadeIn delay={0.2} y={32}>
            <div className="relative aspect-[16/10] overflow-hidden rounded-2xl border border-background/10 bg-background/5">
              <div className="flex h-10 items-center gap-2 border-b border-background/10 bg-background/5 px-4">
                <span className="h-3 w-3 rounded-full bg-background/10" />
                <span className="h-3 w-3 rounded-full bg-background/10" />
                <span className="h-3 w-3 rounded-full bg-background/10" />
              </div>
