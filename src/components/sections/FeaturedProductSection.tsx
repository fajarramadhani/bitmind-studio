        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,5fr)_minmax(0,6fr)] lg:items-center lg:gap-16">
          <FadeIn>
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[clamp(1.1rem,1.5vw,1.35rem)] leading-relaxed text-background/80">
              ...
              <div className="flex flex-col gap-4 border-y border-background/10 py-6">
                <h4 className="text-[0.65rem] font-bold uppercase tracking-[0.25em] text-background/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={cat}
                      className="rounded-full bg-background/5 px-4 py-1.5 text-xs text-background/80"
                    >
                      {cat}
                    </span>
                  ))}
              ...
              <div>
                <Link
                  href="/moments"
                  className="group inline-flex items-center gap-2 rounded-full bg-background px-8 py-4 text-sm font-semibold text-foreground transition-all hover:bg-background/90"
                >
          ...
          <FadeIn delay={0.2} y={32}>
            <div className="relative mx-auto flex max-w-[320px] justify-center">
              ...
              <DeviceFrame className="relative border border-background/20 bg-surface-dark-elevated shadow-2xl">
